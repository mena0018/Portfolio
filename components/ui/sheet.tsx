...
const sheetVariants = cva(
  'fixed inset-x-0 z-50 gap-4 bg-background border-4 border-accent mt-20 shadow-lg flex h-screen max-w-72 flex-col rounded-t-[10px] transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500',
  {
    variants: {
      side: {
        ...
        left: 'top-0 right-0 data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left',
        right:
...
>(({ side = 'left', className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ...
      {...props}
    >
      <div className='mx-auto my-4 h-2 w-[100px] ' />
