...
export const dataProjects: Record<string, ProjectType[]> = {
  FR: [
    ...
    },
    {
      title: "Payment Form",
      description:
        "Formulaire de paiement interactif réalisé dans le cadre d'un challenge Frontend-Mentor.",
      img: PaymentForm,
      url: [
        "https://github.com/mena0018/CreditCard",
        "https://credit-card-theta.vercel.app/",
      ],
      icons: [typescript, react, sass],
    },
    {
  ...
  EN: [
    ...
    },
    {
      title: "Payment Form",
      description:
        "Front-end Mentor Challenge focused on an Interactive payment form.",
      img: PaymentForm,
      url: [
        "https://github.com/mena0018/CreditCard",
        "https://credit-card-theta.vercel.app/",
